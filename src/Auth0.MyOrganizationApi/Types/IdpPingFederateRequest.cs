...
/// </summary>
[Serializable]
public record IdpPingFederateRequest : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required IdpPingFederateRequestStrategy Strategy { get; set; }

    /// <summary>
    /// Identity provider specific options.
    /// </summary>
    [JsonPropertyName("options")]
    public required IdpPingFederateOptionsRequest Options { get; set; }
