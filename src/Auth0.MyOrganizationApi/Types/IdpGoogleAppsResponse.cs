...
/// </summary>
[Serializable]
public record IdpGoogleAppsResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required IdpGoogleAppsResponseStrategy Strategy { get; set; }

    /// <summary>
    /// Identity provider specific options.
    /// </summary>
    [JsonPropertyName("options")]
    public required IdpGoogleAppsOptionsResponse Options { get; set; }
