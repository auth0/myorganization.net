...
/// </summary>
[Serializable]
public record IdpPingFederateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required IdpPingFederateResponseStrategy Strategy { get; set; }

    /// <summary>
    /// Identity provider specific options.
    /// </summary>
    [JsonPropertyName("options")]
    public required IdpPingFederateOptionsResponse Options { get; set; }
