...
[Serializable]
public record IdpProvisioningUserAttributeMapItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    /// </summary>
    [JsonPropertyName("provisioning_field")]
    public required string ProvisioningField { get; set; }
