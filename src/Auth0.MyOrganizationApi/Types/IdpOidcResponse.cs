...
/// </summary>
[Serializable]
public record IdpOidcResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required IdpOidcResponseStrategy Strategy { get; set; }

    /// <summary>
    /// Identity provider specific options.
    /// </summary>
    [JsonPropertyName("options")]
    public required IdpOidcOptionsResponse Options { get; set; }
