...
/// </summary>
[Serializable]
public record IdpWaadRequest : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required IdpWaadRequestStrategy Strategy { get; set; }

    /// <summary>
    /// Identity provider specific options.
    /// </summary>
    [JsonPropertyName("options")]
    public required IdpWaadOptionsRequest Options { get; set; }
