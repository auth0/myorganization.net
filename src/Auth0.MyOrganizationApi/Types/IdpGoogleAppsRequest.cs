...
/// </summary>
[Serializable]
public record IdpGoogleAppsRequest : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required IdpGoogleAppsRequestStrategy Strategy { get; set; }

    /// <summary>
    /// Identity provider specific options.
    /// </summary>
    [JsonPropertyName("options")]
    public required IdpGoogleAppsOptionsRequest Options { get; set; }
