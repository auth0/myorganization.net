...
/// </summary>
[Serializable]
public record IdpWaadResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required IdpWaadResponseStrategy Strategy { get; set; }

    /// <summary>
    /// Identity provider specific options.
    /// </summary>
    [JsonPropertyName("options")]
    public required IdpWaadOptionsResponse Options { get; set; }
