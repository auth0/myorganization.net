...
/// </summary>
[Serializable]
public record IdpOidcRequest : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required IdpOidcRequestStrategy Strategy { get; set; }

    /// <summary>
    /// Identity provider specific options.
    /// </summary>
    [JsonPropertyName("options")]
    public required IdpOidcOptionsRequest Options { get; set; }
