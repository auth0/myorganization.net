...
/// </summary>
[Serializable]
public record IdpOktaRequest : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required IdpOktaRequestStrategy Strategy { get; set; }

    /// <summary>
    /// Identity provider specific options.
    /// </summary>
    [JsonPropertyName("options")]
    public required IdpOktaOptionsRequest Options { get; set; }
