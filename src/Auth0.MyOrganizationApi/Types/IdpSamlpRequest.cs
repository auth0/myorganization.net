...
/// </summary>
[Serializable]
public record IdpSamlpRequest : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required IdpSamlpRequestStrategy Strategy { get; set; }

    /// <summary>
    /// Identity provider specific options.
    /// </summary>
    [JsonPropertyName("options")]
    public required IdpSamlpOptionsRequest Options { get; set; }
