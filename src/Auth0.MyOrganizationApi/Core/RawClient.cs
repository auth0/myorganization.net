...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::Auth0.MyOrganizationApi.Core.ApiResponse> SendRequestAsync(
        global::Auth0.MyOrganizationApi.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::Auth0.MyOrganizationApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::Auth0.MyOrganizationApi.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::Auth0.MyOrganizationApi.Core.BaseRequest request)
    {
