...
namespace Auth0.MyOrganizationApi.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static Auth0.MyOrganizationApi.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new Auth0.MyOrganizationApi.Core.MultipartFormRequest
        {
